import{s as Pn,n as an}from"../chunks/scheduler.IgQUtjbl.js";import{S as Fn,i as jn,g as e,s as o,h as p,C as l,c,j as F,f as s,k as i,a as t}from"../chunks/index.D4Vnkr5k.js";function Un(gn){let u,tn='<a href="#declarative-exception-handling">Declarative Exception Handling</a>',j,y,en="In this article we will explore a potential remedy to the nightmare that is error handling in JS.",U,r,pn='<a href="#the-state-of-error-handling-in-js">The State of Error Handling in JS</a>',I,m,on="If you have a function that might fail, you would probably do something like this.",q,f,Tn=`<code class="language-js"><span class="token keyword">let</span> result<span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`,A,w,cn=`This very common implementation has a bug though. It handles all exceptions, not just the ones we expect to happen during normal operation.
If <code>usafe</code> has a Syntax error in it’s implementation this would silently swallow it. We don’t want that.`,W,v,ln=`A better implementation would be to throw custom error-types for all your expected exceptions
and test anything that’s thrown against those.`,z,x,Cn=`<code class="language-js"><span class="token keyword">class</span> <span class="token class-name">CustomException1</span> <span class="token keyword">extends</span> <span class="token class-name">Error</span> <span class="token punctuation">&#123;</span><span class="token punctuation">&#125;</span>
...
<span class="token punctuation">&#125;</span></code>`,D,H,un=`But the code here gets really really ugly really really fast. We have to imperatively check which Execution path we should take,
opening up the door to many silly bugs.`,J,k,rn='<a href="#what-we-want">What we want</a>',O,g,kn=`Wouldn’t it be really nice if we could declaratively define each execution path an the right thing just happened?
Other languages like Rust would make this pretty easy using Errors-As-Values and <code>match</code> statements. Something like this:`,B,T,bn=`<code class="language-rust"><span class="token keyword">let</span> result <span class="token operator">=</span> <span class="token keyword">match</span> <span class="token function">unsafe_fn</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span><span class="token punctuation">;</span></code>`,V,C,dn="This way we can declaratively define each possible execution branch, drastically reducing the chance of bugs.",Y,d,hn='<a href="#resultmatcher-a-potential-solution"><code>ResultMatcher</code> a potential solution</a>',G,b,yn="I took a stab at implementing a similar API in JS, and I came up with the <code>ResultMatcher</code> class. You can find the full source code at the bottom of this article. It is used like this:",K,M,Mn=`<code class="language-js"><span class="token keyword">const</span> result <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ResultMatcher</span><span class="token punctuation">(</span>unsafe<span class="token punctuation">)</span>
    ...
    <span class="token punctuation">.</span><span class="token function">run</span><span class="token punctuation">(</span><span class="token punctuation">)</span></code>`,N,_,mn="It is fully typesafe making it a breeze to work with.",Q,E,fn="Let’s take a look at each part:",X,R,wn="<li><code>const result</code> will be the return value of whatever execution branch is taken. In the snippet above the return type would be <code>string | null</code></li> <li><code>ResultMatcher(unsafe)</code> constructs a matcher instance for the function <code>unsafe</code></li> <li><code>.ok()</code> takes a callback that handles the return value of <code>unsafe</code> if it succeeds. If <code>.ok</code> is not used on the Matcher it will default to the identity function.</li> <li><code>.catch(CustomException1, e =&gt; null)</code> Will only run if <code>unsafe</code> throws a <code>CustomException1</code>. It may return a value.</li> <li><code>.run()</code> Actually calls <code>unsafe</code>. If unsafe takes args, you will pass them here (Eg: <code>run(&quot;Hello&quot;, {option: &quot;a&quot;})</code>). TS will enforce this.</li>",Z,S,vn="Sometimes you <em>do</em> want to react to all errors that are thrown. Maybe just to log them. For that we have the <code>catchAll</code> method.",$,L,xn="<li><code>.catchAll(e =&gt; {console.error(e); throw e})</code></li>",nn,h,Hn='<a href="#the-snippet">The Snippet</a>',sn,P,_n=`<code class="language-js"><span class="token comment">/**
...
<span class="token punctuation">&#125;</span><span class="token punctuation">;</span></code>`;return{c(){u=e("h1"),u.innerHTML=tn,j=o(),y=e("p"),y.textContent=en,U=o(),r=e("h2"),r.innerHTML=pn,I=o(),m=e("p"),m.textContent=on,q=o(),f=e("pre"),A=o(),w=e("p"),w.innerHTML=cn,W=o(),v=e("p"),v.textContent=ln,z=o(),x=e("pre"),D=o(),H=e("p"),H.textContent=un,J=o(),k=e("h2"),k.innerHTML=rn,O=o(),g=e("p"),g.innerHTML=kn,B=o(),T=e("pre"),V=o(),C=e("p"),C.textContent=dn,Y=o(),d=e("h2"),d.innerHTML=hn,G=o(),b=e("p"),b.innerHTML=yn,K=o(),M=e("pre"),N=o(),_=e("p"),_.textContent=mn,Q=o(),E=e("p"),E.textContent=fn,X=o(),R=e("ul"),R.innerHTML=wn,Z=o(),S=e("p"),S.innerHTML=vn,$=o(),L=e("ul"),L.innerHTML=xn,nn=o(),h=e("h2"),h.innerHTML=Hn,sn=o(),P=e("pre"),this.h()},l(n){u=p(n,"H1",{id:!0,"data-svelte-h":!0}),l(u)!=="svelte-z0u4rw"&&(u.innerHTML=tn),j=c(n),y=p(n,"P",{"data-svelte-h":!0}),l(y)!=="svelte-xe0fn0"&&(y.textContent=en),U=c(n),r=p(n,"H2",{id:!0,"data-svelte-h":!0}),l(r)!=="svelte-xa1j4"&&(r.innerHTML=pn),I=c(n),m=p(n,"P",{"data-svelte-h":!0}),l(m)!=="svelte-j0y3la"&&(m.textContent=on),q=c(n),f=p(n,"PRE",{class:!0});var a=F(f);a.forEach(s),A=c(n),w=p(n,"P",{"data-svelte-h":!0}),l(w)!=="svelte-86uv7g"&&(w.innerHTML=cn),W=c(n),v=p(n,"P",{"data-svelte-h":!0}),l(v)!=="svelte-7telbu"&&(v.textContent=ln),z=c(n),x=p(n,"PRE",{class:!0});var En=F(x);En.forEach(s),D=c(n),H=p(n,"P",{"data-svelte-h":!0}),l(H)!=="svelte-1kgaj31"&&(H.textContent=un),J=c(n),k=p(n,"H2",{id:!0,"data-svelte-h":!0}),l(k)!=="svelte-kzejms"&&(k.innerHTML=rn),O=c(n),g=p(n,"P",{"data-svelte-h":!0}),l(g)!=="svelte-dvkkc4"&&(g.innerHTML=kn),B=c(n),T=p(n,"PRE",{class:!0});var Rn=F(T);Rn.forEach(s),V=c(n),C=p(n,"P",{"data-svelte-h":!0}),l(C)!=="svelte-xy7f4b"&&(C.textContent=dn),Y=c(n),d=p(n,"H2",{id:!0,"data-svelte-h":!0}),l(d)!=="svelte-9hqu1k"&&(d.innerHTML=hn),G=c(n),b=p(n,"P",{"data-svelte-h":!0}),l(b)!=="svelte-tiiv16"&&(b.innerHTML=yn),K=c(n),M=p(n,"PRE",{class:!0});var Sn=F(M);Sn.forEach(s),N=c(n),_=p(n,"P",{"data-svelte-h":!0}),l(_)!=="svelte-h0ke80"&&(_.textContent=mn),Q=c(n),E=p(n,"P",{"data-svelte-h":!0}),l(E)!=="svelte-aex9p"&&(E.textContent=fn),X=c(n),R=p(n,"UL",{"data-svelte-h":!0}),l(R)!=="svelte-1rlehpz"&&(R.innerHTML=wn),Z=c(n),S=p(n,"P",{"data-svelte-h":!0}),l(S)!=="svelte-12ouq9h"&&(S.innerHTML=vn),$=c(n),L=p(n,"UL",{"data-svelte-h":!0}),l(L)!=="svelte-1fgu1t0"&&(L.innerHTML=xn),nn=c(n),h=p(n,"H2",{id:!0,"data-svelte-h":!0}),l(h)!=="svelte-1m2hw0c"&&(h.innerHTML=Hn),sn=c(n),P=p(n,"PRE",{class:!0});var Ln=F(P);Ln.forEach(s),this.h()},h(){i(u,"id","declarative-exception-handling"),i(r,"id","the-state-of-error-handling-in-js"),i(f,"class","language-js"),i(x,"class","language-js"),i(k,"id","what-we-want"),i(T,"class","language-rust"),i(d,"id","resultmatcher-a-potential-solution"),i(M,"class","language-js"),i(h,"id","the-snippet"),i(P,"class","language-js")},m(n,a){t(n,u,a),t(n,j,a),t(n,y,a),t(n,U,a),t(n,r,a),t(n,I,a),t(n,m,a),t(n,q,a),t(n,f,a),f.innerHTML=Tn,t(n,A,a),t(n,w,a),t(n,W,a),t(n,v,a),t(n,z,a),t(n,x,a),x.innerHTML=Cn,t(n,D,a),t(n,H,a),t(n,J,a),t(n,k,a),t(n,O,a),t(n,g,a),t(n,B,a),t(n,T,a),T.innerHTML=bn,t(n,V,a),t(n,C,a),t(n,Y,a),t(n,d,a),t(n,G,a),t(n,b,a),t(n,K,a),t(n,M,a),M.innerHTML=Mn,t(n,N,a),t(n,_,a),t(n,Q,a),t(n,E,a),t(n,X,a),t(n,R,a),t(n,Z,a),t(n,S,a),t(n,$,a),t(n,L,a),t(n,nn,a),t(n,h,a),t(n,sn,a),t(n,P,a),P.innerHTML=_n},p:an,i:an,o:an,d(n){n&&(s(u),s(j),s(y),s(U),s(r),s(I),s(m),s(q),s(f),s(A),s(w),s(W),s(v),s(z),s(x),s(D),s(H),s(J),s(k),s(O),s(g),s(B),s(T),s(V),s(C),s(Y),s(d),s(G),s(b),s(K),s(M),s(N),s(_),s(Q),s(E),s(X),s(R),s(Z),s(S),s($),s(L),s(nn),s(h),s(sn),s(P))}}}class An extends Fn{constructor(u){super(),jn(this,u,null,Un,Pn,{})}}export{An as component};
