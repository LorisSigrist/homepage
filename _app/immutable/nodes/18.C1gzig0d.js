import { s as safe_not_equal, n as noop, f as src_url_equal } from "../chunks/scheduler.ZIqz7M1C.js";
import { S as SvelteComponent, i as init, d as detach, a as insert_hydration, k as attr, z as set_style, c as claim_element, l as get_svelte_dataset, g as claim_space, m as claim_html_tag, h as element, j as space, H as HtmlTagHydration } from "../chunks/index.D4FFmrY2.js";
...
<span class="line"><span style="color:#BD976A">	</span><span style="color:#BD976A"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#CB7676">var </span><span style="color:#BD976A">console</span><span style="color:#666666">: </span><span style="color:#5DA994">Console</span></code></span>console</span></span><span style="color:#666666">.</span><span style="color:#80A665"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#BD976A">Console</span><span style="color:#666666">.</span><span style="color:#80A665">log</span><span style="color:#666666">(...</span><span style="color:#BD976A">data</span><span style="color:#DBD7CAEE">: </span><span style="color:#BD976A">any</span><span style="color:#666666">[])</span><span style="color:#DBD7CAEE">: </span><span style="color:#CB7676">void</span></code></span>log</span></span><span style="color:#666666">(</span><span style="color:#BD976A"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#CB7676">const </span><span style="color:#BD976A">value</span><span style="color:#666666">: </span><span style="color:#5DA994">Uint8Array</span></code></span>value</span></span><span style="color:#666666">);</span></span>
<span class="line"><span style="color:#666666">&#125;</span></span></code></pre>`;
  let t24;
  let p9;
...
In our case, we want a TransformStream that takes in a stream of raw binary data and outputs a stream of strings. This is such a common task that there actually is a built in one, the <a href="https://developer.mozilla.org/en-US/docs/Web/API/TextDecoderStream" rel="noopener noreferrer" target="_blank"><code>TextDecoderStream</code></a>. Let’s use that. Don’t worry, we will be creating our own TransformStreams later on.`;
  ...
  let t37;
  let html_tag_2;
  let raw2_value = `<pre class="shiki vitesse-dark twoslash lsp" style="background-color:#121212;color:#dbd7caee" tabindex="0"><code><span class="line"><span style="color:#CB7676">const </span><span style="color:#BD976A"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#CB7676">const </span><span style="color:#BD976A">stream</span><span style="color:#666666">: </span><span style="color:#5DA994">ReadableStream</span><span style="color:#666666">&#x3C;</span><span style="color:#5DA994">string</span><span style="color:#666666">></span></code></span>stream</span></span><span style="color:#666666"> =</span><span style="color:#BD976A"> </span><span style="color:#BD976A"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#CB7676">const </span><span style="color:#BD976A">request</span><span style="color:#666666">: </span><span style="color:#5DA994">Request</span></code></span>request</span></span><span style="color:#666666">.</span><span style="color:#BD976A"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#BD976A">Body</span><span style="color:#666666">.</span><span style="color:#BD976A">body</span><span style="color:#DBD7CAEE">: </span><span style="color:#BD976A">ReadableStream</span><span style="color:#666666">&#x3C;</span><span style="color:#BD976A">Uint8Array</span><span style="color:#666666">></span><span style="color:#CB7676"> |</span><span style="color:#CB7676"> null</span></code></span>body</span></span><span style="color:#CB7676">!</span><span style="color:#666666">.</span><span style="color:#80A665"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#BD976A">ReadableStream</span><span style="color:#666666">&#x3C;</span><span style="color:#BD976A">Uint8Array</span><span style="color:#666666">>.</span><span style="color:#80A665">pipeThrough</span><span style="color:#666666">&#x3C;</span><span style="color:#5DA994">string</span><span style="color:#666666">>(</span><span style="color:#BD976A">transform</span><span style="color:#DBD7CAEE">: </span><span style="color:#BD976A">ReadableWritablePair</span><span style="color:#666666">&#x3C;</span><span style="color:#BD976A">string</span><span style="color:#666666">,</span><span style="color:#BD976A"> Uint8Array</span><span style="color:#666666">>,</span><span style="color:#BD976A"> options</span><span style="color:#CB7676">?:</span><span style="color:#BD976A"> StreamPipeOptions</span><span style="color:#CB7676"> |</span><span style="color:#CB7676"> undefined</span><span style="color:#666666">)</span><span style="color:#DBD7CAEE">: </span><span style="color:#BD976A">ReadableStream</span><span style="color:#666666">&#x3C;</span><span style="color:#BD976A">string</span><span style="color:#666666">></span></code></span>pipeThrough</span></span><span style="color:#666666">(</span><span style="color:#CB7676">new </span><span style="color:#80A665"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#CB7676">var </span><span style="color:#BD976A">TextDecoderStream</span><span style="color:#666666">: </span><span style="color:#4D9375">new</span><span style="color:#666666"> (</span><span style="color:#BD976A">label</span><span style="color:#CB7676">?</span><span style="color:#666666">: </span><span style="color:#5DA994">string</span><span style="color:#666666"> | </span><span style="color:#CB7676">undefined</span><span style="color:#666666">, </span><span style="color:#BD976A">options</span><span style="color:#CB7676">?</span><span style="color:#666666">: </span><span style="color:#5DA994">TextDecoderOptions</span><span style="color:#666666"> | </span><span style="color:#CB7676">undefined</span><span style="color:#666666">) => </span><span style="color:#5DA994">TextDecoderStream</span></code></span>TextDecoderStream</span></span><span style="color:#666666">());</span></span></code></pre>`;
  let t38;
  let p12;
...
<span class="line"><span style="color:#BD976A">    description</span><span style="color:#666666">: </span><span style="color:#5DA994">string</span><span style="color:#666666">;</span></span>
<span class="line"><span style="color:#BD976A">    done</span><span style="color:#666666">: </span><span style="color:#5DA994">boolean</span><span style="color:#666666">;</span></span>
<span class="line"><span style="color:#666666">&#125;> | </span><span style="color:#CB7676">undefined</span><span style="color:#666666">, </span><span style="color:#BD976A">writableStrategy</span><span style="color:#CB7676">?</span><span style="color:#666666">: </span><span style="color:#5DA994">QueuingStrategy</span><span style="color:#666666">&#x3C;</span><span style="color:#5DA994">unknown</span><span style="color:#666666">> | </span><span style="color:#CB7676">undefined</span><span style="color:#666666">, </span><span style="color:#BD976A">readableStrategy</span><span style="color:#CB7676">?</span><span style="color:#666666">: </span><span style="color:#5DA994">QueuingStrategy</span><span style="color:#666666">&#x3C;...> | </span><span style="color:#CB7676">undefined</span><span style="color:#666666">) => </span><span style="color:#5DA994">TransformStream</span><span style="color:#666666">&#x3C;...></span></span></code></pre></code></span>TransformStream</span></span><span style="color:#666666">&#x3C;</span><span style="color:#5DA994">unknown</span><span style="color:#666666">,</span><span style="color:#5DA994"> </span><span style="color:#5DA994"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><pre class="shiki vitesse-dark" style="background-color:#121212;color:#dbd7caee" tabindex="0"><code><span class="line"><span style="color:#CB7676">type</span><span style="color:#5DA994"> Todo</span><span style="color:#666666"> =</span><span style="color:#666666"> &#123;</span></span>
<span class="line"><span style="color:#BD976A">    description</span><span style="color:#666666">: </span><span style="color:#5DA994">string</span><span style="color:#666666">;</span></span>
<span class="line"><span style="color:#BD976A">    done</span><span style="color:#666666">: </span><span style="color:#5DA994">boolean</span><span style="color:#666666">;</span></span>
<span class="line"><span style="color:#666666">&#125;</span></span></code></pre></code></span>Todo</span></span><span style="color:#666666">>(&#123;</span></span>
...
<span class="line"><span style="color:#666666">&#125;</span></span></code></pre>`;
  ...
  return {
    ...
    l(nodes) {
      ...
      if (get_svelte_dataset(h1) !== "svelte-1tquwwz") h1.innerHTML = textContent;
      t1 = claim_space(nodes);
      p0 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p0) !== "svelte-10izeu3") p0.textContent = textContent_1;
      t3 = claim_space(nodes);
      html_tag = claim_html_tag(nodes, false);
      t4 = claim_space(nodes);
      p1 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p1) !== "svelte-1waqisa") p1.textContent = textContent_2;
      ...
      if (get_svelte_dataset(p2) !== "svelte-1e5tf9p") p2.textContent = textContent_3;
      t9 = claim_space(nodes);
      p3 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p3) !== "svelte-1mgs7p8") p3.textContent = textContent_4;
      t11 = claim_space(nodes);
      blockquote0 = claim_element(nodes, "BLOCKQUOTE", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(blockquote0) !== "svelte-14ytl9r") blockquote0.innerHTML = textContent_5;
      t15 = claim_space(nodes);
      p6 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p6) !== "svelte-166in9b") p6.textContent = textContent_6;
      t17 = claim_space(nodes);
      p7 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p7) !== "svelte-1pdvwy4") p7.innerHTML = textContent_7;
      t21 = claim_space(nodes);
      p8 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p8) !== "svelte-h55bag") p8.textContent = textContent_8;
      t23 = claim_space(nodes);
      html_tag_1 = claim_html_tag(nodes, false);
      t24 = claim_space(nodes);
      p9 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p9) !== "svelte-fcg9yf") p9.innerHTML = textContent_9;
      ...
      if (get_svelte_dataset(p10) !== "svelte-n1hc4n") p10.innerHTML = textContent_10;
      t33 = claim_space(nodes);
      p11 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p11) !== "svelte-owqyst") p11.innerHTML = textContent_11;
      ...
      if (get_svelte_dataset(p12) !== "svelte-1igzqy3") p12.textContent = textContent_12;
      ...
      if (get_svelte_dataset(p13) !== "svelte-14fgtdo") p13.innerHTML = textContent_13;
      t45 = claim_space(nodes);
      p14 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p14) !== "svelte-1nabusx") p14.innerHTML = textContent_14;
      ...
      if (get_svelte_dataset(p15) !== "svelte-19puwgb") p15.innerHTML = textContent_15;
      t58 = claim_space(nodes);
      p16 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p16) !== "svelte-1ir7oz5") p16.innerHTML = textContent_16;
      ...
      if (get_svelte_dataset(blockquote1) !== "svelte-1en34yb") blockquote1.innerHTML = textContent_17;
      t67 = claim_space(nodes);
      p18 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p18) !== "svelte-18hh2of") p18.innerHTML = textContent_18;
      ...
      if (get_svelte_dataset(p19) !== "svelte-1bec8xu") p19.innerHTML = textContent_19;
      ...
      if (get_svelte_dataset(p20) !== "svelte-1r27hss") p20.textContent = textContent_20;
      ...
      if (get_svelte_dataset(p21) !== "svelte-2kxuce") p21.textContent = textContent_21;
      t91 = claim_space(nodes);
      p22 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p22) !== "svelte-1sp1uam") p22.textContent = textContent_22;
      ...
      if (get_svelte_dataset(p23) !== "svelte-8o6b7i") p23.textContent = textContent_23;
      t97 = claim_space(nodes);
      p24 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p24) !== "svelte-26lz5m") p24.textContent = textContent_24;
      ...
      if (get_svelte_dataset(p25) !== "svelte-143g0y4") p25.textContent = textContent_25;
      ...
      if (get_svelte_dataset(p26) !== "svelte-z1901r") p26.textContent = textContent_26;
      ...
      if (get_svelte_dataset(p27) !== "svelte-16ergwb") p27.textContent = textContent_27;
      ...
      if (get_svelte_dataset(p28) !== "svelte-1levvwx") p28.textContent = textContent_28;
      t111 = claim_space(nodes);
      p29 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p29) !== "svelte-7lz10") p29.innerHTML = textContent_29;
      ...
      if (get_svelte_dataset(p30) !== "svelte-jzzcb8") p30.textContent = textContent_30;
      ...
      if (get_svelte_dataset(p31) !== "svelte-3mjbt0") p31.innerHTML = textContent_31;
      ...
      if (get_svelte_dataset(p32) !== "svelte-vzc5cp") p32.textContent = textContent_32;
      ...
      if (get_svelte_dataset(p33) !== "svelte-1vn92sb") p33.textContent = textContent_33;
      t130 = claim_space(nodes);
      ol = claim_element(nodes, "OL", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(ol) !== "svelte-5fot8a") ol.innerHTML = textContent_34;
      t142 = claim_space(nodes);
      p34 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p34) !== "svelte-mnwotl") p34.textContent = textContent_35;
      this.h();
    },
    h() {
      attr(h1, "id", "the-better-way-to-load-data");
      html_tag.a = t4;
      if (!src_url_equal(img0.src, img0_src_value = NonStreamLoadGif)) attr(img0, "src", img0_src_value);
      ...
      html_tag_1.a = t24;
      if (!src_url_equal(img1.src, img1_src_value = RawStreamGif)) attr(img1, "src", img1_src_value);
      ...
      html_tag_2.a = t38;
      if (!src_url_equal(img2.src, img2_src_value = TextStreamGif)) attr(img2, "src", img2_src_value);
      ...
      html_tag_3.a = t50;
      html_tag_4.a = t63;
      if (!src_url_equal(img3.src, img3_src_value = ParseResultValueStreamGif)) attr(img3, "src", img3_src_value);
      ...
      html_tag_5.a = t85;
      html_tag_6.a = t88;
      if (!src_url_equal(img4.src, img4_src_value = FinalStreamGif)) attr(img4, "src", img4_src_value);
      ...
      html_tag_7.a = t94;
      if (!src_url_equal(img5.src, img5_src_value = StreamLoadGif)) attr(img5, "src", img5_src_value);
      ...
      html_tag_11.a = t109;
      html_tag_12.a = t116;
      if (!src_url_equal(img6.src, img6_src_value = forAwaitOfCompat)) attr(img6, "src", img6_src_value);
