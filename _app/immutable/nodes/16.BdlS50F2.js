...
<span class="line"><span style="color:#CB7676">const </span><span style="color:#BD976A"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#CB7676">const </span><span style="color:#BD976A">response</span><span style="color:#666666">: </span><span style="color:#5DA994">Response</span></code></span>response</span></span><span style="color:#666666"> =</span><span style="color:#4D9375"> await</span><span style="color:#80A665"> </span><span style="color:#80A665"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#CB7676">function</span><span style="color:#80A665"> fetch</span><span style="color:#666666">(</span><span style="color:#BD976A">input</span><span style="color:#666666">: </span><span style="color:#5DA994">RequestInfo</span><span style="color:#666666"> | </span><span style="color:#5DA994">URL</span><span style="color:#666666">,</span><span style="color:#BD976A"> init</span><span style="color:#CB7676">?</span><span style="color:#666666">: </span><span style="color:#5DA994">RequestInit</span><span style="color:#666666"> | </span><span style="color:#CB7676">undefined</span><span style="color:#666666">):</span><span style="color:#5DA994"> Promise</span><span style="color:#666666">&#x3C;</span><span style="color:#5DA994">Response</span><span style="color:#666666">></span></code></span>fetch</span></span><span style="color:#666666">(</span><span style="color:#C98A7D99">"</span><span style="color:#C98A7D">/todos</span><span style="color:#C98A7D99">"</span><span style="color:#666666">);</span><span style="color:#758575DD">    //fetch</span></span>
...
<span class="line"><span style="color:#666666">&#125;</span></span></code></pre>`;
  ...
  let t23;
  let html_tag_1;
  let raw1_value = `<pre class="shiki vitesse-dark twoslash lsp" style="background-color:#121212;color:#dbd7caee" tabindex="0"><code><span class="line"><span style="color:#CB7676">const </span><span style="color:#BD976A"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#CB7676">const </span><span style="color:#BD976A">response</span><span style="color:#666666">: </span><span style="color:#5DA994">Response</span></code></span>response</span></span><span style="color:#666666"> =</span><span style="color:#4D9375"> await</span><span style="color:#80A665"> </span><span style="color:#80A665"><span class="twoslash-hover"><span class="twoslash-popup-container"><code class="twoslash-popup-code"><span style="color:#CB7676">function</span><span style="color:#80A665"> fetch</span><span style="color:#666666">(</span><span style="color:#BD976A">input</span><span style="color:#666666">: </span><span style="color:#5DA994">RequestInfo</span><span style="color:#666666"> | </span><span style="color:#5DA994">URL</span><span style="color:#666666">,</span><span style="color:#BD976A"> init</span><span style="color:#CB7676">?</span><span style="color:#666666">: </span><span style="color:#5DA994">RequestInit</span><span style="color:#666666"> | </span><span style="color:#CB7676">undefined</span><span style="color:#666666">):</span><span style="color:#5DA994"> Promise</span><span style="color:#666666">&#x3C;</span><span style="color:#5DA994">Response</span><span style="color:#666666">></span></code></span>fetch</span></span><span style="color:#666666">(</span><span style="color:#C98A7D99">'</span><span style="color:#C98A7D">/list</span><span style="color:#C98A7D99">'</span><span style="color:#666666">);</span></span>
