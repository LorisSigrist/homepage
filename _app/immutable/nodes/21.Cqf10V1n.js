...
import { S as SvelteComponent, w as init, q as detach, x as insert_hydration, b as attr, g as claim_element, t as get_svelte_dataset, i as claim_space, r as element, G as space } from "../chunks/index.9NSNOADf.js";
function create_fragment(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      if (get_svelte_dataset(h1) !== "svelte-ufx8du") h1.innerHTML = textContent;
      t1 = claim_space(nodes);
      p0 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p0) !== "svelte-1d6oa7n") p0.innerHTML = textContent_1;
      t15 = claim_space(nodes);
      p1 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p1) !== "svelte-1c3opg") p1.textContent = textContent_2;
      t17 = claim_space(nodes);
      h20 = claim_element(nodes, "H2", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h20) !== "svelte-1dbq4ie") h20.innerHTML = textContent_3;
      t19 = claim_space(nodes);
      p2 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p2) !== "svelte-1lmsl0h") p2.innerHTML = textContent_4;
      t29 = claim_space(nodes);
      p3 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p3) !== "svelte-1ylsc2g") p3.textContent = textContent_5;
      t31 = claim_space(nodes);
      ul = claim_element(nodes, "UL", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(ul) !== "svelte-1ozutpm") ul.innerHTML = textContent_6;
      t44 = claim_space(nodes);
      h21 = claim_element(nodes, "H2", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h21) !== "svelte-kmpttn") h21.innerHTML = textContent_7;
      t46 = claim_space(nodes);
      p4 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p4) !== "svelte-1wyw34r") p4.textContent = textContent_8;
      t48 = claim_space(nodes);
      p5 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p5) !== "svelte-cgzeq0") p5.innerHTML = textContent_9;
      t52 = claim_space(nodes);
      p6 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p6) !== "svelte-1irwun8") p6.innerHTML = textContent_10;
      t56 = claim_space(nodes);
      p7 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p7) !== "svelte-14seq6k") p7.innerHTML = textContent_11;
      this.h();
    },
    h() {
