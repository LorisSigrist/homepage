import { y as safe_not_equal, u as noop, c as add_render_callback, C as src_url_equal, h as component_subscribe, f as binding_callbacks, b as add_flush_callback } from "../chunks/scheduler.BUCu-78n.js";
import { S as SvelteComponent, w as init, q as detach, p as destroy_each, C as set_data, A as select_option, x as insert_hydration, a as append_hydration, y as listen, b as attr, g as claim_element, e as children, t as get_svelte_dataset, i as claim_space, k as claim_text, r as element, G as space, J as text, D as set_input_value, B as select_value, o as destroy_component, L as transition_out, K as transition_in, z as mount_component, E as set_style, f as claim_component, h as claim_html_tag, n as create_component, H as HtmlTagHydration, c as bind } from "../chunks/index.9NSNOADf.js";
...
function create_fragment$2(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      if (get_svelte_dataset(label0) !== "svelte-76cqnf") label0.textContent = textContent;
      ...
      if (get_svelte_dataset(label1) !== "svelte-1hh6i4f") label1.textContent = textContent_1;
...
function instance$2($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("currency" in $$props2) $$invalidate(0, currency = $$props2.currency);
  };
...
<span class="line"><span style="color:#666666">&#x3C;/</span><span style="color:#4D9375">div</span><span style="color:#666666">></span></span></code></pre>`;
  ...
  return {
    ...
    l(nodes) {
      ...
      if (get_svelte_dataset(h1) !== "svelte-1c99y9k") h1.innerHTML = textContent;
      t2 = claim_space(nodes);
      p0 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p0) !== "svelte-1nfzanq") p0.innerHTML = textContent_1;
      t7 = claim_space(nodes);
      p1 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p1) !== "svelte-18dlu86") p1.textContent = textContent_2;
      t9 = claim_space(nodes);
      blockquote = claim_element(nodes, "BLOCKQUOTE", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(blockquote) !== "svelte-19rq70s") blockquote.innerHTML = textContent_3;
      t15 = claim_space(nodes);
      h20 = claim_element(nodes, "H2", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h20) !== "svelte-1yc6z9s") h20.innerHTML = textContent_4;
      t19 = claim_space(nodes);
      p3 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p3) !== "svelte-b8x8v1") p3.innerHTML = textContent_5;
      t26 = claim_space(nodes);
      p4 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p4) !== "svelte-zgjvll") p4.innerHTML = textContent_6;
      ...
      if (get_svelte_dataset(p5) !== "svelte-1u5fjv7") p5.textContent = textContent_7;
      ...
      if (get_svelte_dataset(p6) !== "svelte-125vlas") p6.innerHTML = textContent_8;
      t39 = claim_space(nodes);
      h21 = claim_element(nodes, "H2", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h21) !== "svelte-19msz8s") h21.innerHTML = textContent_9;
      t41 = claim_space(nodes);
      p7 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p7) !== "svelte-fzdzvx") p7.innerHTML = textContent_10;
      t45 = claim_space(nodes);
      p8 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p8) !== "svelte-1ty6p2m") p8.textContent = textContent_11;
      t47 = claim_space(nodes);
      p9 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p9) !== "svelte-iqic7") p9.innerHTML = textContent_12;
      t51 = claim_space(nodes);
      h22 = claim_element(nodes, "H2", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h22) !== "svelte-g4lzcy") h22.innerHTML = textContent_13;
      t53 = claim_space(nodes);
      p10 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p10) !== "svelte-6xo8zs") p10.innerHTML = textContent_14;
      t61 = claim_space(nodes);
      p11 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p11) !== "svelte-1p7cu7f") p11.innerHTML = textContent_15;
      t64 = claim_space(nodes);
      p12 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p12) !== "svelte-1x5ums4") p12.innerHTML = textContent_16;
      t72 = claim_space(nodes);
      p13 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p13) !== "svelte-oj51vm") p13.innerHTML = textContent_17;
      t78 = claim_space(nodes);
      h23 = claim_element(nodes, "H2", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h23) !== "svelte-y4vibp") h23.innerHTML = textContent_18;
      t80 = claim_space(nodes);
      p14 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p14) !== "svelte-10i90ff") p14.innerHTML = textContent_19;
      t84 = claim_space(nodes);
      h30 = claim_element(nodes, "H3", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h30) !== "svelte-k0gyvc") h30.innerHTML = textContent_20;
      t86 = claim_space(nodes);
      p15 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p15) !== "svelte-pmrn8n") p15.innerHTML = textContent_21;
      t92 = claim_space(nodes);
      p16 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p16) !== "svelte-tco0th") p16.textContent = textContent_22;
      t94 = claim_space(nodes);
      p17 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p17) !== "svelte-xjwy4l") p17.textContent = textContent_23;
      t96 = claim_space(nodes);
      p18 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p18) !== "svelte-5yw9cd") p18.innerHTML = textContent_24;
      t104 = claim_space(nodes);
      h31 = claim_element(nodes, "H3", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h31) !== "svelte-1c5ubnl") h31.innerHTML = textContent_25;
      t106 = claim_space(nodes);
      p19 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p19) !== "svelte-1ilqcs0") p19.innerHTML = textContent_26;
      t113 = claim_space(nodes);
      p20 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p20) !== "svelte-1qv6h5") p20.innerHTML = textContent_27;
      t119 = claim_space(nodes);
      p21 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p21) !== "svelte-mh5nvu") p21.innerHTML = textContent_28;
      t123 = claim_space(nodes);
      p22 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p22) !== "svelte-1qc1hy1") p22.innerHTML = textContent_29;
      t129 = claim_space(nodes);
      h32 = claim_element(nodes, "H3", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h32) !== "svelte-l8rx0d") h32.innerHTML = textContent_30;
      t131 = claim_space(nodes);
      p23 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p23) !== "svelte-1r4ze8n") p23.innerHTML = textContent_31;
      t137 = claim_space(nodes);
      h24 = claim_element(nodes, "H2", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h24) !== "svelte-7dsikd") h24.innerHTML = textContent_32;
      t139 = claim_space(nodes);
      p24 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p24) !== "svelte-ogcuk0") p24.innerHTML = textContent_33;
      t143 = claim_space(nodes);
      p25 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p25) !== "svelte-8zz4cd") p25.innerHTML = textContent_34;
      t146 = claim_space(nodes);
      p26 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p26) !== "svelte-1k4cmzk") p26.innerHTML = textContent_35;
      this.h();
    },
    h() {
      if (!src_url_equal(img.src, img_src_value = BannerSrc)) attr(img, "src", img_src_value);
