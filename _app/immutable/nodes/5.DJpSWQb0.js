import { s as safe_not_equal, n as noop, f as src_url_equal, r as run_all } from "../chunks/scheduler.ZIqz7M1C.js";
import { S as SvelteComponent, i as init, d as detach, a as insert_hydration, b as append_hydration, B as listen, k as attr, c as claim_element, l as get_svelte_dataset, g as claim_space, e as children, n as empty, h as element, j as space, s as set_data, f as claim_text, t as text } from "../chunks/index.D4FFmrY2.js";
...
function create_if_block(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      if (get_svelte_dataset(h20) !== "svelte-1lw6rbr") h20.textContent = textContent;
      ...
      if (get_svelte_dataset(button0) !== "svelte-1uk9zfx") button0.textContent = textContent_1;
      t5 = claim_space(nodes);
      h21 = claim_element(nodes, "H2", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(h21) !== "svelte-hrchcr") h21.textContent = textContent_2;
      ...
      if (get_svelte_dataset(button1) !== "svelte-19vpth4") button1.textContent = textContent_3;
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      ...
      ctx2[0].toString(2) + "")) set_data(t2, t2_value);
      if (dirty & /*godelNumber*/
      1) set_data(
        t8,
        /*godelNumber*/
...
function create_fragment(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      if (get_svelte_dataset(h1) !== "svelte-jmj27g") h1.textContent = textContent;
      t1 = claim_space(nodes);
      p0 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p0) !== "svelte-1t177dy") p0.textContent = textContent_1;
      t3 = claim_space(nodes);
      h20 = claim_element(nodes, "H2", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(h20) !== "svelte-1cc68ee") h20.textContent = textContent_2;
      t5 = claim_space(nodes);
      p1 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p1) !== "svelte-u7bjnq") p1.textContent = textContent_3;
      t7 = claim_space(nodes);
      img = claim_element(nodes, "IMG", { src: true, alt: true });
      t8 = claim_space(nodes);
      p2 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p2) !== "svelte-a1cbns") p2.textContent = textContent_4;
      t10 = claim_space(nodes);
      h21 = claim_element(nodes, "H2", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(h21) !== "svelte-yhwwis") h21.textContent = textContent_5;
      t12 = claim_space(nodes);
      label = claim_element(nodes, "LABEL", {});
      var label_nodes = children(label);
      span = claim_element(label_nodes, "SPAN", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(span) !== "svelte-jqq2qy") span.textContent = textContent_6;
    ...
    h() {
      if (!src_url_equal(img.src, img_src_value = flaci_download_button_image)) attr(img, "src", img_src_value);
