...
Thanks to it’s very fast build times, it has used so little of my free minutes that it doesn’t even show up on my usage graph.`;
  ...
  return {
    ...
    l(nodes) {
      ...
      if (get_svelte_dataset(h1) !== "svelte-9p66gw") h1.innerHTML = textContent;
      t1 = claim_space(nodes);
      p0 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p0) !== "svelte-1g4chr8") p0.textContent = textContent_1;
      t3 = claim_space(nodes);
      p1 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p1) !== "svelte-1t7o281") p1.textContent = textContent_2;
      t5 = claim_space(nodes);
      h2 = claim_element(nodes, "H2", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h2) !== "svelte-1lcav2") h2.innerHTML = textContent_3;
      t7 = claim_space(nodes);
      p2 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p2) !== "svelte-89pvv2") p2.textContent = textContent_4;
      t9 = claim_space(nodes);
      p3 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p3) !== "svelte-29252j") p3.innerHTML = textContent_5;
      t13 = claim_space(nodes);
      html_tag = claim_html_tag(nodes, false);
      t14 = claim_space(nodes);
      p4 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p4) !== "svelte-6cmld4") p4.innerHTML = textContent_6;
      t18 = claim_space(nodes);
      p5 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p5) !== "svelte-17pw9xo") p5.textContent = textContent_7;
      this.h();
    },
    h() {
