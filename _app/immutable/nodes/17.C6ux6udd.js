...
<span class="line"><span style="color:#666666">&#x3C;/</span><span style="color:#4D9375">html</span><span style="color:#666666">></span></span></code></pre>`;
  ...
  return {
    ...
    l(nodes) {
      ...
      if (get_svelte_dataset(h1) !== "svelte-zlnnuw") h1.innerHTML = textContent;
      t1 = claim_space(nodes);
      blockquote0 = claim_element(nodes, "BLOCKQUOTE", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(blockquote0) !== "svelte-3lttfb") blockquote0.innerHTML = textContent_1;
      t5 = claim_space(nodes);
      p1 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p1) !== "svelte-e34hy7") p1.innerHTML = textContent_2;
      t9 = claim_space(nodes);
      h20 = claim_element(nodes, "H2", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h20) !== "svelte-b2uuaj") h20.innerHTML = textContent_3;
      t11 = claim_space(nodes);
      p2 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p2) !== "svelte-11smj55") p2.innerHTML = textContent_4;
      t17 = claim_space(nodes);
      p3 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p3) !== "svelte-1kaf9f8") p3.innerHTML = textContent_5;
      t29 = claim_space(nodes);
      p4 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p4) !== "svelte-1gzzywg") p4.textContent = textContent_6;
      t31 = claim_space(nodes);
      p5 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p5) !== "svelte-kxnsll") p5.textContent = textContent_7;
      t33 = claim_space(nodes);
      p6 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p6) !== "svelte-1pdxkij") p6.innerHTML = textContent_8;
      t43 = claim_space(nodes);
      h21 = claim_element(nodes, "H2", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h21) !== "svelte-1nn6mce") h21.innerHTML = textContent_9;
      t45 = claim_space(nodes);
      p7 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p7) !== "svelte-4ldeh") p7.innerHTML = textContent_10;
      t53 = claim_space(nodes);
      blockquote1 = claim_element(nodes, "BLOCKQUOTE", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(blockquote1) !== "svelte-lj5gi9") blockquote1.innerHTML = textContent_11;
      t55 = claim_space(nodes);
      html_tag = claim_html_tag(nodes, false);
      t56 = claim_space(nodes);
      p9 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p9) !== "svelte-cg0sd") p9.innerHTML = textContent_12;
      t66 = claim_space(nodes);
      blockquote2 = claim_element(nodes, "BLOCKQUOTE", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(blockquote2) !== "svelte-1tnuzsl") blockquote2.innerHTML = textContent_13;
      t70 = claim_space(nodes);
      p11 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p11) !== "svelte-1bwmhjq") p11.textContent = textContent_14;
      t72 = claim_space(nodes);
      h22 = claim_element(nodes, "H2", { id: true, ["data-svelte-h"]: true });
      if (get_svelte_dataset(h22) !== "svelte-hz2d2g") h22.innerHTML = textContent_15;
      t74 = claim_space(nodes);
      p12 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p12) !== "svelte-l3p4rp") p12.innerHTML = textContent_16;
      this.h();
    },
    h() {
