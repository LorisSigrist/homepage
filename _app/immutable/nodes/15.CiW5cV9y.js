...
<span class="line"><span style="color:#666666">&#x3C;/</span><span style="color:#B8A965">Tooltip</span><span style="color:#666666">></span></span></code></pre>`;
  ...
  return {
    ...
    l(nodes) {
      ...
      if (get_svelte_dataset(h1) !== "svelte-15fqgkm") h1.innerHTML = textContent;
      t1 = claim_space(nodes);
      p0 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p0) !== "svelte-we6q8g") p0.innerHTML = textContent_1;
      t5 = claim_space(nodes);
      p1 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p1) !== "svelte-sm233c") p1.textContent = textContent_2;
      t7 = claim_space(nodes);
      p2 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p2) !== "svelte-fb05oo") p2.innerHTML = textContent_3;
      t13 = claim_space(nodes);
      html_tag = claim_html_tag(nodes, false);
      t14 = claim_space(nodes);
      p3 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p3) !== "svelte-qcbyx") p3.innerHTML = textContent_4;
      t22 = claim_space(nodes);
      html_tag_1 = claim_html_tag(nodes, false);
      t23 = claim_space(nodes);
      p4 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p4) !== "svelte-jwgito") p4.textContent = textContent_5;
      t25 = claim_space(nodes);
      p5 = claim_element(nodes, "P", { ["data-svelte-h"]: true });
      if (get_svelte_dataset(p5) !== "svelte-1hcs8n2") p5.textContent = textContent_6;
      this.h();
    },
    h() {
